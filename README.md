...
1) KA algorithm-
   ...
   Repository used- https://github.com/kopang/LinearSuffixArray.git
   Use the Makefile provided to compile the code (excutable named test would be present)
   Now, to excute the linear suffix array construction algorithm on a given dataset, use the below command-
